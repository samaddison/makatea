...
def test_audit_events_model_parsing():
    ...
    assert event1.timestamp.isoformat()[:19] == "2025-04-23T10:24:55"  # Just check date and time without microseconds
    ...
    assert event2.data.error == "Access denied"  # Extra field handled through ExtraBaseModel
